...
@Setter
@ToString
public class EditSnakeFormBean {
    ...
    // it gives 500 error if submit form without birthday - have to regex that or something later
    @DateTimeFormat(pattern = "yyyy-MM-dd")
    private LocalDate birthDate;

    private String note;

    // age is not working as expected - fix later
